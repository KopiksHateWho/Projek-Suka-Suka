...
## 2024-05-24 - Delightful Utility: Clipboard Integration
**Learning:** Copy-to-clipboard functionality provides high delight and utility when applied to hard-to-memorize data like Order IDs or phone numbers. Integrating this with a global toast system ensures the user gets immediate confirmation without leaving the current view.
**Action:** Identify unique identifiers or contact details that users are likely to share or save. Add a "copy" button nearby and trigger a "Copied!" toast to confirm success.
